        ...
        <div class='vevent' itemscope="" itemtype="http://schema.org/Event">
            <?php if (isset($context->event->subtitle)): ?><header><?php endif; ?>
                <h2 id="heading-date" class='summary' data-datetime="<?php echo (new DateTime($context->getStartTime()))->format('c') ?>">
                    <a class="dcf-txt-decor-none" href="<?php echo $url; ?>" itemprop="url">
                        <span itemprop="name"><?php echo $savvy->dbStringtoHtml($context->event->displayTitle($context)); ?></span>
                    </a>
                </h2>
            ...
            <img class="event_description_img" src="<?php echo $imageURL ?>" aria-hidden="true" alt="" itemprop="image">
            <?php endif; ?>
            <p class="download">
